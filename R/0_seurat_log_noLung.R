...
dir.create(paste0("/data/GI-Informatics/DePasquale/Projects/Bondoc_HB/Resolution_", resolution, "noLung"))
...
sample3<-getFiles("/data/GI-Informatics/DePasquale/Projects/Bondoc_HB/Cell_Ranger/10X-Bondoc-HB17-Background-20191001-3v3hg/HB17B/strainedCounts", "HB17B", "Background")
...
sample.all <- merge(sample1,
y = c(sample2, sample3, sample4, sample5, sample7, sample8, sample9, sample10, sample11, sample12, sample13, sample15, sample16, sample17,
      sample19, sample20, sample21, sample22, sample23, sample29, sample30),
add.cell.ids = c("81T", "96UES", "HB17B", "HB17P", "HB17T", "HB30P", "HB30T", "HB31B", "HB31T", "HB35P", "HB53B", "HB53T", "HB60P",
  "HB60T", "HB70T", "HB82T", "HB83B", "HB83T", "HB85B", "HB85T", "80B", "80T"),
project = "sampleAll")
